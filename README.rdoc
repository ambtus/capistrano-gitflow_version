...
Gitflow simply adds some tagging/logging/workflow magic to the multistage recipe.
    ...
    # tag 'MAJOR.MINOR.REVISION.BUILD' created; points to test-MAJOR.MINOR.REVISION.BUILD
...
* if the last tag was MAJOR.MINOR.REVISION.BUILD will ask you if you are bumping MAJOR, MINOR, or REVISION
* create a new tag
